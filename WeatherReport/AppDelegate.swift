...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        Location.shared.locationManager.delegate = Location.shared.self
        Location.shared.locationManager.desiredAccuracy = kCLLocationAccuracyBest
        Location.shared.locationManager.requestWhenInUseAuthorization()
        Location.shared.locationManager.startUpdatingLocation()
        return true
    }
